...
module.exports = {
    ...
    create(context) {
        ...
        function check(node) {
            ...
            /*
             * MULTILINE: true
             * loop through every element and check if at least one element has linebreaks inside
             * or if there are linebreaks between elements.
             *
             * Arrays and Objects are exempt because it is often desired to have their closing
             * brackets on the same line as the next one's opening bracket.
             */
                ...
                elementBreak = elements
                    ...
                    .some((element, index) => {
                      return element.type !== "ObjectExpression" &&
                        ...
                        index < elements.length - 1 && (((elements[index + 1] || {}).loc || {}).start || {}).line &&
